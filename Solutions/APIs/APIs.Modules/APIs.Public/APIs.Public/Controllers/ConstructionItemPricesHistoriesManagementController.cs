...
{
    /// <summary>
    /// ConstructionItemPricesHistoriesManagement
    /// </summary>
    [CustomApiAuthentication]
    public class ConstructionItemPricesHistoriesManagementController : ApiBaseController
    {
        /// <summary>
        /// ConstructionItemPricesHistoriesManagement
        /// </summary>
        ...
        public ConstructionItemPricesHistoriesManagementController(IHostEnvironment _hostingEnvironment,
        ...
        /// <summary>
        /// GetListOfConstructionItemPricesHistories
        /// </summary>
        /// <param name="getListOfConstructionItemsPVM"></param>
        /// <returns>JsonResultWithRecordsObjectVM</returns>
        [HttpPost("GetListOfConstructionItemPricesHistories")]
        [ProducesResponseType(typeof(JsonResultWithRecordsObjectVM), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(void), (int)HttpStatusCode.BadRequest)]
        public IActionResult GetListOfConstructionItemPricesHistories(GetListOfConstructionItemPricesHistoriesPVM getListOfConstructionItemPricesHistoriesPVM)
        {
            JsonResultWithRecordsObjectVM jsonResultWithRecordsObjectVM = new JsonResultWithRecordsObjectVM(new object() { });
            ...
            try
            {
                ...
                var listOfConstructionItems = publicApiBusiness.GetListOfConstructionItemPricesHistories(getListOfConstructionItemPricesHistoriesPVM.jtStartIndex.Value,
                    getListOfConstructionItemPricesHistoriesPVM.jtPageSize.Value,
                    ref listCount,
                    getListOfConstructionItemPricesHistoriesPVM.ParentType,
                    getListOfConstructionItemPricesHistoriesPVM.ParentId,
                    getListOfConstructionItemPricesHistoriesPVM.DateTimeTo,
                    getListOfConstructionItemPricesHistoriesPVM.jtSorting);
