...
{
    [Area("Admin")]
    public class DomainsSettingManagementController : ExtraAdminController
    {
        ...
        {
            ViewData["Title"] = "لیست دامنه ها";

            if (ViewData["CustomUsersVMList"] == null)
            {
                //var roleId = business.GetRoleIdWithRoleName("Admins", domain);
                ViewData["CustomUsersVMList"] = consoleBusiness.GetUsersList(0, 0/*roleId*/, this.userId.Value);
            }
        ...
        {
            ViewData["Title"] = "تعریف دامنه";

            if (ViewData["DataBackUrl"] == null)
            {
                ViewData["DataBackUrl"] = "/Admin/DomainsSettingManagement/Index";
            }
            ...
            if (ViewData["CustomUsersVMList"] == null)
            {
                ...
                ViewData["CustomUsersVMList"] = consoleBusiness.GetUsersList(0, this.roleId.Value, this.userId.Value);
            }
        ...
        public IActionResult AddToDomainsSetting(DomainsSettingsVM domainSettingsVM)
        {
            try
            {
                if (!consoleBusiness.CheckLimitationOfDefinedDomainsSetting(this.userId.Value, this.domainsSettings.DomainSettingId))
                {
                    ...
                    string body = @"<div style=""text-align: center;""><h3>" +
                        "DomainsSettingDefineLimitation"  + 
                        "</h3></div>";
                    ...
                    {
                        Result = "ERROR",
                        Message = "DomainsSettingDefineLimitation"
                    });
                }
        ...
        public IActionResult UpdateDomainSetting(DomainsSettingsVM domainSettingsVM)
        {
            try
            {
                    ...
                    domainSettingsVM.DomainName, domainSettingsVM.UserIdCreator.Value))
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        if (consoleBusiness.UpdateDomainSetting(domainSettingsVM, false))
                        {
                            return Json(new
                            {
                                Result = "OK",
        ...
        public IActionResult HierarchyOfDomainUsers(long Id = 0)
        {
            ...
            { }
            return View("HierarchyOfUsers", usersList);
        }

        public IActionResult HierarchyOfTreeViewDomainUsers(long Id = 0)
        {
