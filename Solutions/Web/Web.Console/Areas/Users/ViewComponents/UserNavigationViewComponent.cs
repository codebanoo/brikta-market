...
namespace Web.Console.Areas.Users.ViewComponents
{
    public class UserNavigationViewComponent : ViewComponent
    {
        ...
        public UserNavigationViewComponent(IHostEnvironment _hostEnvironment,
        ...
        public IViewComponentResult Invoke()
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        //users
                        var level = levels.Where(l => l.RoleId.Equals(3)).FirstOrDefault();
                        if (level != null) {

                            var role = roles.Where(r => r.RoleId.Equals(3)).FirstOrDefault();
